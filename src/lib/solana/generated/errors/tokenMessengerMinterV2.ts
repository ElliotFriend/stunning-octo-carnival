...
export function isTokenMessengerMinterV2Error<TProgramErrorCode extends TokenMessengerMinterV2Error>(
    error: unknown,
  ...
  return isProgramError<TProgramErrorCode>(error, transactionMessage, TOKEN_MESSENGER_MINTER_V2_PROGRAM_ADDRESS, code);
}