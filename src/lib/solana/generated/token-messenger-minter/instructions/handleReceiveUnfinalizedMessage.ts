...
export const HANDLE_RECEIVE_UNFINALIZED_MESSAGE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([200, 169, 175, 20, 200, 58, 182, 61]);

export function getHandleReceiveUnfinalizedMessageDiscriminatorBytes(): ReadonlyUint8Array { return fixEncoderSize(getBytesEncoder(), 8).encode(HANDLE_RECEIVE_UNFINALIZED_MESSAGE_DISCRIMINATOR); }
...
export type HandleReceiveUnfinalizedMessageInstructionData = { discriminator: ReadonlyUint8Array; params: HandleReceiveMessageParams;  };

export type HandleReceiveUnfinalizedMessageInstructionDataArgs = { params: HandleReceiveMessageParamsArgs;  };
...
export function getHandleReceiveUnfinalizedMessageInstructionDataEncoder(): Encoder<HandleReceiveUnfinalizedMessageInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['params', getHandleReceiveMessageParamsEncoder()]]), (value) => ({ ...value, discriminator: HANDLE_RECEIVE_UNFINALIZED_MESSAGE_DISCRIMINATOR }));
}
...
export function getHandleReceiveUnfinalizedMessageInstructionDataCodec(): Codec<HandleReceiveUnfinalizedMessageInstructionDataArgs, HandleReceiveUnfinalizedMessageInstructionData> {
    return combineCodec(getHandleReceiveUnfinalizedMessageInstructionDataEncoder(), getHandleReceiveUnfinalizedMessageInstructionDataDecoder());
}

export type HandleReceiveUnfinalizedMessageAsyncInput<TAccountAuthorityPda extends string = string, TAccountTokenMessenger extends string = string, TAccountRemoteTokenMessenger extends string = string, TAccountTokenMinter extends string = string, TAccountLocalToken extends string = string, TAccountTokenPair extends string = string, TAccountFeeRecipientTokenAccount extends string = string, TAccountRecipientTokenAccount extends string = string, TAccountCustodyTokenAccount extends string = string, TAccountTokenProgram extends string = string, TAccountEventAuthority extends string = string, TAccountProgram extends string = string> =  {
...
return Object.freeze({ accounts: [getAccountMeta("authorityPda", accounts.authorityPda), getAccountMeta("tokenMessenger", accounts.tokenMessenger), getAccountMeta("remoteTokenMessenger", accounts.remoteTokenMessenger), getAccountMeta("tokenMinter", accounts.tokenMinter), getAccountMeta("localToken", accounts.localToken), getAccountMeta("tokenPair", accounts.tokenPair), getAccountMeta("feeRecipientTokenAccount", accounts.feeRecipientTokenAccount), getAccountMeta("recipientTokenAccount", accounts.recipientTokenAccount), getAccountMeta("custodyTokenAccount", accounts.custodyTokenAccount), getAccountMeta("tokenProgram", accounts.tokenProgram), getAccountMeta("eventAuthority", accounts.eventAuthority), getAccountMeta("program", accounts.program)], data: getHandleReceiveUnfinalizedMessageInstructionDataEncoder().encode(args as HandleReceiveUnfinalizedMessageInstructionDataArgs), programAddress } as HandleReceiveUnfinalizedMessageInstruction<TProgramAddress, TAccountAuthorityPda, TAccountTokenMessenger, TAccountRemoteTokenMessenger, TAccountTokenMinter, TAccountLocalToken, TAccountTokenPair, TAccountFeeRecipientTokenAccount, TAccountRecipientTokenAccount, TAccountCustodyTokenAccount, TAccountTokenProgram, TAccountEventAuthority, TAccountProgram>);
}

export type HandleReceiveUnfinalizedMessageInput<TAccountAuthorityPda extends string = string, TAccountTokenMessenger extends string = string, TAccountRemoteTokenMessenger extends string = string, TAccountTokenMinter extends string = string, TAccountLocalToken extends string = string, TAccountTokenPair extends string = string, TAccountFeeRecipientTokenAccount extends string = string, TAccountRecipientTokenAccount extends string = string, TAccountCustodyTokenAccount extends string = string, TAccountTokenProgram extends string = string, TAccountEventAuthority extends string = string, TAccountProgram extends string = string> =  {
  authorityPda: TransactionSigner<TAccountAuthorityPda>;
tokenMessenger: Address<TAccountTokenMessenger>;
remoteTokenMessenger: Address<TAccountRemoteTokenMessenger>;
tokenMinter: Address<TAccountTokenMinter>;
...
export type ParsedHandleReceiveUnfinalizedMessageInstruction<TProgram extends string = typeof TOKEN_MESSENGER_MINTER_V2_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
...
export function parseHandleReceiveUnfinalizedMessageInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedHandleReceiveUnfinalizedMessageInstruction<TProgram, TAccountMetas> {
