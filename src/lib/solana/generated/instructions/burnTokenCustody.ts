...
export const BURN_TOKEN_CUSTODY_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([233, 136, 180, 175, 112, 41, 62, 71]);

export function getBurnTokenCustodyDiscriminatorBytes(): ReadonlyUint8Array { return fixEncoderSize(getBytesEncoder(), 8).encode(BURN_TOKEN_CUSTODY_DISCRIMINATOR); }
...
export type BurnTokenCustodyInstructionData = { discriminator: ReadonlyUint8Array; amount: bigint;  };

export type BurnTokenCustodyInstructionDataArgs = { amount: number | bigint;  };

export function getBurnTokenCustodyInstructionDataEncoder(): FixedSizeEncoder<BurnTokenCustodyInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['amount', getU64Encoder()]]), (value) => ({ ...value, discriminator: BURN_TOKEN_CUSTODY_DISCRIMINATOR }));
}

export function getBurnTokenCustodyInstructionDataDecoder(): FixedSizeDecoder<BurnTokenCustodyInstructionData> {
    return getStructDecoder([['discriminator', fixDecoderSize(getBytesDecoder(), 8)], ['amount', getU64Decoder()]]);
}

export function getBurnTokenCustodyInstructionDataCodec(): FixedSizeCodec<BurnTokenCustodyInstructionDataArgs, BurnTokenCustodyInstructionData> {
    return combineCodec(getBurnTokenCustodyInstructionDataEncoder(), getBurnTokenCustodyInstructionDataDecoder());
}

export type BurnTokenCustodyAsyncInput<TAccountPayee extends string = string, TAccountTokenController extends string = string, TAccountTokenMinter extends string = string, TAccountLocalToken extends string = string, TAccountCustodyTokenAccount extends string = string, TAccountCustodyTokenMint extends string = string, TAccountTokenProgram extends string = string, TAccountEventAuthority extends string = string, TAccountProgram extends string = string> =  {
...
return Object.freeze({ accounts: [getAccountMeta("payee", accounts.payee), getAccountMeta("tokenController", accounts.tokenController), getAccountMeta("tokenMinter", accounts.tokenMinter), getAccountMeta("localToken", accounts.localToken), getAccountMeta("custodyTokenAccount", accounts.custodyTokenAccount), getAccountMeta("custodyTokenMint", accounts.custodyTokenMint), getAccountMeta("tokenProgram", accounts.tokenProgram), getAccountMeta("eventAuthority", accounts.eventAuthority), getAccountMeta("program", accounts.program)], data: getBurnTokenCustodyInstructionDataEncoder().encode(args as BurnTokenCustodyInstructionDataArgs), programAddress } as BurnTokenCustodyInstruction<TProgramAddress, TAccountPayee, TAccountTokenController, TAccountTokenMinter, TAccountLocalToken, TAccountCustodyTokenAccount, TAccountCustodyTokenMint, TAccountTokenProgram, TAccountEventAuthority, TAccountProgram>);
}

export type BurnTokenCustodyInput<TAccountPayee extends string = string, TAccountTokenController extends string = string, TAccountTokenMinter extends string = string, TAccountLocalToken extends string = string, TAccountCustodyTokenAccount extends string = string, TAccountCustodyTokenMint extends string = string, TAccountTokenProgram extends string = string, TAccountEventAuthority extends string = string, TAccountProgram extends string = string> =  {
  payee: TransactionSigner<TAccountPayee>;
tokenController: TransactionSigner<TAccountTokenController>;
tokenMinter: Address<TAccountTokenMinter>;
localToken: Address<TAccountLocalToken>;
...
export type ParsedBurnTokenCustodyInstruction<TProgram extends string = typeof TOKEN_MESSENGER_MINTER_V2_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
...
export function parseBurnTokenCustodyInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedBurnTokenCustodyInstruction<TProgram, TAccountMetas> {
