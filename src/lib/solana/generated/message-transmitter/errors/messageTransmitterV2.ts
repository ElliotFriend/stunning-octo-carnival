...
export function isMessageTransmitterV2Error<TProgramErrorCode extends MessageTransmitterV2Error>(
  ...
  return isProgramError<TProgramErrorCode>(error, transactionMessage, MESSAGE_TRANSMITTER_V2_PROGRAM_ADDRESS, code);
}